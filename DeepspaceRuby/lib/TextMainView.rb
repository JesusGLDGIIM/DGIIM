...
class TextMainView
  ...
  def wonConvertCombatMessage
    if @gameUI.currentEnemy.loot.efficient
      puts "Has GANADO el combate y tu estación ahora es más eficiente. \tDisfruta de tu botín"
    else
      puts "Has GANADO el combate y tu estación se ha convertido en una ciudad espacial. \tDisfruta de tu botín"
    end
  end
